...
/** Returns all supported language keys (excluding 'novice' and 'default') */
export function getSupportedLanguageKeys(): string[] {
  return Object.keys(JOB_CLASSES).filter(
    (k) => k !== "novice" && k !== "default",
  );
}
